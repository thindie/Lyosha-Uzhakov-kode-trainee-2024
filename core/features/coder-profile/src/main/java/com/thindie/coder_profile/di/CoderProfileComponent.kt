...
import com.thindie.coders.di.DaggerCodersMainComponent
...
@CoderProfileScope
@Component(
    dependencies = [DependenciesProvider::class],modules = [ViewModelFactoryModule::class, ViewModelModule::class]
)
interface CoderProfileComponent {
    companion object {
        fun init(dependenciesProvider: DependenciesProvider): CoderProfileComponent {

            return DaggerCodersMainComponent.factory()
